...
`);
  if (target === "all" || target === "claude") {
    ...
    if (!import_fs.default.existsSync(claudeCmdDir)) import_fs.default.mkdirSync(claudeCmdDir, { recursive: true });
    AI_SKILLS.forEach((skill) => {
...
`;
  ...
  if (target === "all" || target === "cursor") {
    ...
    if (!import_fs.default.existsSync(cursorRulesDir)) import_fs.default.mkdirSync(cursorRulesDir, { recursive: true });
    AI_SKILLS.forEach((skill) => {
      const cmdName = toCommandName(skill.slug);
      const filePath = import_path.default.join(cursorRulesDir, `${cmdName}.mdc`);
      const fileContent = `---
...
`;
  ...
  if (target === "all" || target === "antigravity") {
    ...
    AI_SKILLS.forEach((skill) => {
      ...
      if (!import_fs.default.existsSync(skillDir)) import_fs.default.mkdirSync(skillDir, { recursive: true });
...
`;
  ...
  if (target === "all" || target === "continue") {
    const continuePromptsDir = import_path.default.join(cwd, ".continue", "prompts");
    if (!import_fs.default.existsSync(continuePromptsDir)) import_fs.default.mkdirSync(continuePromptsDir, { recursive: true });
    AI_SKILLS.forEach((skill) => {
      const cmdName = toCommandName(skill.slug);
      const filePath = import_path.default.join(continuePromptsDir, `${cmdName}.prompt`);
...
`;
  ...
  if (target === "all" || target === "copilot") {
    const copilotPromptsDir = import_path.default.join(cwd, ".github", "prompts");
    if (!import_fs.default.existsSync(copilotPromptsDir)) import_fs.default.mkdirSync(copilotPromptsDir, { recursive: true });
    AI_SKILLS.forEach((skill) => {
      const cmdName = toCommandName(skill.slug);
      const filePath = import_path.default.join(copilotPromptsDir, `${cmdName}.prompt.md`);
      const fileContent = `---
name: ${cmdName}
description: ${skill.description}
---
...
`;
    ...
    const instructionsPath = import_path.default.join(cwd, ".github", "copilot-instructions.md");
...
`;
    import_fs.default.writeFileSync(instructionsPath, instructionsContent, "utf8");
  ...
  if (target === "all" || target === "windsurf") {
    const windsurfDir = import_path.default.join(cwd, ".windsurf", "workflows");
    if (!import_fs.default.existsSync(windsurfDir)) import_fs.default.mkdirSync(windsurfDir, { recursive: true });
    AI_SKILLS.forEach((skill) => {
      const cmdName = toCommandName(skill.slug);
      const filePath = import_path.default.join(windsurfDir, `${cmdName}.md`);
...
\u274C Error: Skill with slug '${slug}' not found.`);
  ...
  switch (editor) {
    case "cursor": {
      ...
      if (!import_fs.default.existsSync(rulesDir)) import_fs.default.mkdirSync(rulesDir, { recursive: true });
      targetPath = import_path.default.join(rulesDir, `${cmdName}.mdc`);
      fileContent = `---
description: ${skill.description}
globs: *
alwaysApply: true
...
`;
    ...
    case "claude": {
      ...
      if (!import_fs.default.existsSync(cmdDir)) import_fs.default.mkdirSync(cmdDir, { recursive: true });
...
`;
    ...
    case "antigravity": {
      const skillDir = import_path.default.join(process.cwd(), ".agents", "skills", skill.slug);
      if (!import_fs.default.existsSync(skillDir)) import_fs.default.mkdirSync(skillDir, { recursive: true });
...
`;
    ...
    case "continue": {
      const continueDir = import_path.default.join(process.cwd(), ".continue", "prompts");
      if (!import_fs.default.existsSync(continueDir)) import_fs.default.mkdirSync(continueDir, { recursive: true });
      targetPath = import_path.default.join(continueDir, `${cmdName}.prompt`);
...
`;
    ...
    case "copilot": {
      const copilotDir = import_path.default.join(process.cwd(), ".github", "prompts");
      if (!import_fs.default.existsSync(copilotDir)) import_fs.default.mkdirSync(copilotDir, { recursive: true });
      targetPath = import_path.default.join(copilotDir, `${cmdName}.prompt.md`);
      fileContent = `---
name: ${cmdName}
description: ${skill.description}
---
...
`;
    ...
    case "windsurf": {
      const wsDir = import_path.default.join(process.cwd(), ".windsurf", "workflows");
      if (!import_fs.default.existsSync(wsDir)) import_fs.default.mkdirSync(wsDir, { recursive: true });
      targetPath = import_path.default.join(wsDir, `${cmdName}.md`);
