...
`;
  ...
  if (target === "all" || target === "continue") {
    const continuePromptsDir = import_path2.default.join(cwd, ".continue", "prompts");
    if (!import_fs2.default.existsSync(continuePromptsDir)) import_fs2.default.mkdirSync(continuePromptsDir, { recursive: true });
    AI_SKILLS.forEach((skill) => {
      const cmdName = toCommandName(skill.slug);
      const filePath = import_path2.default.join(continuePromptsDir, `${cmdName}.prompt`);
...
`;
  ...
  if (target === "all" || target === "copilot") {
    const copilotPromptsDir = import_path2.default.join(cwd, ".github", "prompts");
    if (!import_fs2.default.existsSync(copilotPromptsDir)) import_fs2.default.mkdirSync(copilotPromptsDir, { recursive: true });
    AI_SKILLS.forEach((skill) => {
      const cmdName = toCommandName(skill.slug);
      const filePath = import_path2.default.join(copilotPromptsDir, `${cmdName}.prompt.md`);
      const fileContent = `---
name: ${cmdName}
description: ${skill.description}
---
...
`;
    ...
    const instructionsPath = import_path2.default.join(cwd, ".github", "copilot-instructions.md");
...
`;
    import_fs2.default.writeFileSync(instructionsPath, instructionsContent, "utf8");
  ...
  if (target === "all" || target === "windsurf") {
    const windsurfDir = import_path2.default.join(cwd, ".windsurf", "workflows");
    if (!import_fs2.default.existsSync(windsurfDir)) import_fs2.default.mkdirSync(windsurfDir, { recursive: true });
    AI_SKILLS.forEach((skill) => {
      const cmdName = toCommandName(skill.slug);
      const filePath = import_path2.default.join(windsurfDir, `${cmdName}.md`);
