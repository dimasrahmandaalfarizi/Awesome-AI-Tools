...
export const INSTINCTS_TEMPLATE = [
  ...
  "- **Verification**: Always run verification builds before marking tasks complete.",
  "",
  "## Anti-Patterns (Strictly Prohibited)",
  "- **Zero AI Slop**: Do NOT use decorative rainbow gradient overlays, emojis in JSX, or meaningless glow icons.",
  ...
  "- *Integration*: 2,558 skills are triggered via /<command> in Claude/Continue, @<rule> in Cursor, and SKILL.md in Antigravity.",
  "- *Subagents*: 136 specialist personas are stored in .agents/subagents/.",
