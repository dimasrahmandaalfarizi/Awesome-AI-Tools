...
description: Run kube-bench (Aqua Security) against a Kubernetes clusters control-plane, kubelet, and node configuration to check compliance with the CIS Kubernetes Benchmark and remediate PASS/FAIL/WARN findings. Use when establishing a security baseline for ...
